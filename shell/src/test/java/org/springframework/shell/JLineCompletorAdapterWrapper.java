...
public class JLineCompletorAdapterWrapper extends JLineCompletorAdapter {
    ...
    private TestableShell shell = null;

    public JLineCompletorAdapterWrapper(Parser parser, TestableShell shell) {
        super(parser);
        this.shell = shell;
    }
    ...
    public int complete(final String buffer, final int cursor, final List candidates) {
        logger.debug("Called wrapper adaptor for input string ..." + buffer);
