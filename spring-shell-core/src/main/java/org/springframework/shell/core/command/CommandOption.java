 ...
 */
public record CommandOption(String longName, String longNameModified, Character shortName,
	...
	public static CommandOption of(String longNames, Character shortNames, String description, ResolvableType type) {
		return new CommandOption(longNames, "", shortNames, description, type, false, null, -1, -1, -1, null, null);
	}
