...
import org.springframework.shell.core.tui.component.flow.ComponentFlow.BaseBuilder;
...
public abstract class BaseNumberInput extends BaseInput<NumberInputSpec> implements NumberInputSpec {
	...
	private @Nullable Number resultValue;
	...
	private @Nullable Function<NumberInputContext, List<AttributedString>> renderer;
	...
	private @Nullable Function<NumberInputContext, String> next;
	...
	public @Nullable Number getResultValue() {
		return resultValue;
	}
	...
	public @Nullable Function<NumberInputContext, List<AttributedString>> getRenderer() {
		return renderer;
	}
	...
	public @Nullable Function<NumberInputContext, String> getNext() {
		return next;
	}
