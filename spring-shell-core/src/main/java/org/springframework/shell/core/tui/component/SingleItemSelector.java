...
import org.springframework.shell.core.tui.component.support.AbstractSelectorComponent;
import org.springframework.shell.core.tui.component.support.Enableable;
import org.springframework.shell.core.tui.component.support.Itemable;
import org.springframework.shell.core.tui.component.support.Matchable;
import org.springframework.shell.core.tui.component.support.Nameable;
import org.springframework.shell.core.tui.component.support.Selectable;
...
public class SingleItemSelector<T, I extends Nameable & Matchable & Enableable & Selectable & Itemable<T>>
	...
	private @Nullable SingleItemSelectorContext<T, I> currentContext;

	public SingleItemSelector(Terminal terminal, List<I> items, @Nullable String name,
	...
	@Override
	public SingleItemSelectorContext<T, I> getThisContext(@Nullable ComponentContext<?> context) {
