...
import org.springframework.shell.core.tui.component.view.event.KeyBindingConsumer;
import org.springframework.shell.core.tui.component.view.event.KeyBindingConsumerArgs;
...
import org.springframework.shell.core.tui.component.view.event.MouseBindingConsumer;
import org.springframework.shell.core.tui.component.view.event.MouseBindingConsumerArgs;
import org.springframework.shell.core.tui.component.view.event.MouseEvent;
import org.springframework.shell.core.tui.component.view.event.MouseHandler;
...
public abstract class AbstractView extends AbstractControl implements View {
	...
	private void registerKeyBinding(Integer keyType, @Nullable String keyCommand,
			@Nullable KeyBindingConsumer keyConsumer, @Nullable Runnable keyRunnable) {
	...
	private void registerHotKeyBinding(Integer keyType, @Nullable String keyCommand,
			@Nullable KeyBindingConsumer keyConsumer, @Nullable Runnable keyRunnable) {
	...
	record KeyBindingValue(@Nullable String keyCommand, @Nullable KeyBindingConsumer keyConsumer,
			@Nullable Runnable keyRunnable) {
		static KeyBindingValue of(@Nullable KeyBindingValue old, @Nullable String keyCommand,
				@Nullable KeyBindingConsumer keyConsumer, @Nullable Runnable keyRunnable) {
			if (old == null) {
	...
	record MouseBindingValue(@Nullable String mouseCommand, @Nullable MouseBindingConsumer mouseConsumer,
			@Nullable Runnable mouseRunnable, @Nullable Predicate<MouseEvent> mousePredicate) {
		static MouseBindingValue of(@Nullable MouseBindingValue old, @Nullable String mouseCommand,
				@Nullable MouseBindingConsumer mouseConsumer, @Nullable Runnable mouseRunnable,
	...
	private void registerMouseBinding(Integer mouseType, @Nullable String mouseCommand,
			@Nullable MouseBindingConsumer mouseConsumer, @Nullable Runnable mouseRunnable) {
