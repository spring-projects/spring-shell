...
import org.springframework.shell.core.tui.component.view.control.ButtonView.ButtonViewSelectEvent;
...
public class DialogView extends WindowView {
	...
	private void hookButtonEvents() {
		buttons.forEach(b -> {
			...
			if (eventLoop != null) {
				onDestroy(eventLoop.viewEvents(ButtonViewSelectEvent.class, b).subscribe(event -> {
					dispatch();
