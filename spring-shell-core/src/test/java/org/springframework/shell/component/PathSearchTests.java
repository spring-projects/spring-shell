...
public class PathSearchTests {
	...
	static Stream<Arguments> testParts() {
		return Stream.of(Arguments.of("0", new int[] { 0 }, Arrays.asList(PartText.of("0", true))),
				Arguments.of("01", new int[] { 0, 1 }, Arrays.asList(PartText.of("0", true), PartText.of("1", true))),
				Arguments.of("012", new int[] { 0, 1, 2 },
						Arrays.asList(PartText.of("0", true), PartText.of("1", true), PartText.of("2", true))),
				Arguments.of("0123456789", new int[0], Arrays.asList(PartText.of("0123456789", false))),
				Arguments.of("0123456789", new int[] { 0 },
						Arrays.asList(PartText.of("0", true), PartText.of("123456789", false))),
				Arguments.of("0123456789", new int[] { 1 },
						Arrays.asList(PartText.of("0", false), PartText.of("1", true), PartText.of("23456789", false))),
				Arguments.of("0123456789", new int[] { 9 },
						Arrays.asList(PartText.of("012345678", false), PartText.of("9", true))),
				Arguments.of("0123456789", new int[] { 2, 5 },
						Arrays.asList(PartText.of("01", false), PartText.of("2", true), PartText.of("34", false),
								PartText.of("5", true), PartText.of("6789", false))),
				Arguments.of("0123456789", new int[] { 2, 3 },
						Arrays.asList(PartText.of("01", false), PartText.of("2", true), PartText.of("3", true),
								PartText.of("456789", false))),
				Arguments.of("0123456789", new int[] { 8, 9 },
						Arrays.asList(PartText.of("01234567", false), PartText.of("8", true), PartText.of("9", true))),
				Arguments.of(
						...
						Arrays.asList(PartText.of("spring-shell-", false), PartText.of("c", true),
