...
import static org.springframework.shell.core.tui.support.search.AbstractSearchMatchAlgorithm.BONUS_BOUNDARY_WHITE;
...
import static org.springframework.shell.core.tui.support.search.AbstractSearchMatchAlgorithm.BONUS_NON_WORD;
import static org.springframework.shell.core.tui.support.search.AbstractSearchMatchAlgorithm.SCORE_GAP_EXTENSION;
import static org.springframework.shell.core.tui.support.search.AbstractSearchMatchAlgorithm.SCORE_GAP_START;
	...
	static Stream<Arguments> testFuzzyMatchV1Backward() {
		return Stream.of(
				Arguments.of(false, true, "foobar fb", "fb", 0, 4, new int[] { 0, 3 },
						SCORE_MATCH * 2 + BONUS_BOUNDARY_WHITE * BONUS_FIRST_CHAR_MULTIPLIER + SCORE_GAP_START
								+ SCORE_GAP_EXTENSION),
