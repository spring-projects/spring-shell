...
import static org.springframework.shell.core.tui.table.SimpleHorizontalAligner.*;
import static org.springframework.shell.core.tui.table.SimpleVerticalAligner.*;
 ...
 * @author Eric Bottard
 */
class TableTest extends AbstractTestWithSample {
	...
	@Test
	void testExpandingColumns() throws IOException {
	...
	@Test
	void testAutoWrapping() throws IOException {
	...
	@Test
	void testEmptyCellsVerticalAligner() {
