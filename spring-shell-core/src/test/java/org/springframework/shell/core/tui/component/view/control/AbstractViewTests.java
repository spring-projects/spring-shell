...
import org.springframework.shell.core.tui.component.view.ScreenAssert; // FIXME change test packages as well
import org.springframework.shell.core.tui.component.view.event.DefaultEventLoop;
...
import org.springframework.shell.core.tui.component.view.event.KeyHandler.KeyHandlerResult;
...
import org.springframework.shell.core.tui.component.view.event.MouseHandler.MouseHandlerResult;
import org.springframework.shell.core.tui.component.view.screen.DefaultScreen;
	...
	protected void configure(View view) {
		...
		if (eventLoop != null) {
			...
			eventLoop.onDestroy(eventLoop.mouseEvents()
				...
				.subscribe());
			eventLoop.onDestroy(
					eventLoop.keyEvents().doOnNext(m -> view.getKeyHandler().handle(KeyHandler.argsOf(m))).subscribe());
		}
	}
