...
public final class CharacterSets {
	...
	public static final String[] ASCII_NAMES = { "<nul>", "<soh>", "<stx>", "<etx>", "<eot>", "<enq>", "<ack>",
	...
	/**
	 * The DEC special characters (only the last 32 characters). Contains [light][heavy]
	 * flavors for box drawing
	 */
	...
	/**
	 * Returns the character mapping for a given original value using the given graphic
	 * sets GL and GR.
