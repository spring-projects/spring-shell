...
/**
 * General interface that obtains styled range of characters at coordinates (<b>x</b>,
 * <b>y</b>) when the screen starts at <b>startRow</b>
 *
...
public interface StyledTextConsumer {
	 ...
	 * @param startRow number of the first row. It can be different for different buffers,
	 * e.g. backBuffer starts from 0, textBuffer and scrollBuffer from -count
	 */
