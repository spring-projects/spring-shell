...
public enum CharacterSet {
	 ...
	 * @return a character set name corresponding to the given character, defaulting to
	 * ASCII if no mapping could be made.
	 */
	 ...
	 * @return a mapped character, or -1 if no mapping could be made and the ASCII value
	 * should be used.
	 */
	public abstract int map(int index);

	/**
	 * Returns whether or not the given designation character belongs to this character
	 * set's set of designations.
	 * @param designation the designation to test for.
	 * @return {@code true} if the given designation character maps to this character set,
	 * {@code true} otherwise.
	 */
