...
public class JLineShellComponent extends JLineShell implements SmartLifecycle,
  ...
  public void findCommands(ApplicationContext appCtx) {
    Map<String, CommandMarker> commands = BeanFactoryUtils.beansOfTypeIncludingAncestors(appCtx, CommandMarker.class);
    for(CommandMarker command : commands.values()) {
      getSimpleParser().add(command);
    }

    Map<String, Converter> converters = BeanFactoryUtils.beansOfTypeIncludingAncestors(appCtx, Converter.class);
  ...
  public void setPluginApplicationContext(ApplicationContext pluginContext) {
  ...
  public void onApplicationEvent(ContextRefreshedEvent event) {
    findCommands(event.getApplicationContext());
  }
  ...
  private <T extends PluginProvider> T getHighestPriorityProvider(Class<T> t) {
    Map<String, T> providers = BeanFactoryUtils.beansOfTypeIncludingAncestors(this.pluginContext, t);
