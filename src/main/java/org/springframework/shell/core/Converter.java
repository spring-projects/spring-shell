...
public interface Converter<T> {
	...
	/**
	 * The prefix for the option context property that indicates how many successive invocations of tab completion have
	 * occurred.
	 */
	public static final String NB_INVOCATIONS_OPTION_CONTEXT_PREFIX = "nb-invocations-";
