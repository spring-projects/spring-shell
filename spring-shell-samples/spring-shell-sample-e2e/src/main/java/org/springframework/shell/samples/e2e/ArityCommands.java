...
public class ArityCommands {
	...
	public static class LegacyAnnotation extends BaseE2ECommands {
		...
		public String testArityStringArrayLegacyAnnotation(@ShellOption(value = "--arg1", arity = 3) String[] arg1) {
			return "Hello " + Arrays.asList(arg1);
		}

		@ShellMethod(key = LEGACY_ANNO + "arity-float-array", group = GROUP)
		public String testArityFloatArrayLegacyAnnotation(@ShellOption(value = "--arg1", arity = 3) float[] arg1) {
	...
	public static class Annotation extends BaseE2ECommands {
		...
		public String testArityBooleanDefaultTrueAnnotation(@Option(longNames = "overwrite", defaultValue = "true",
				arity = OptionArity.ZERO_OR_ONE) Boolean overwrite) {
			return "Hello " + overwrite;
		}

		@Command(command = "arity-string-array")
		public String testArityStringArrayAnnotation(
				@Option(longNames = "arg1", defaultValue = "true", arityMax = 3) String[] arg1) {
			return "Hello " + Arrays.asList(arg1);
		}

		@Command(command = "arity-float-array")
		public String testArityFloatArrayAnnotation(
				@Option(longNames = "arg1", defaultValue = "true", arity = OptionArity.ZERO_OR_MORE) float[] arg1) {
			return "Hello " + stringOfFloats(arg1);
		}

		@Command(command = "string-arityeone-required")
		public String testStringArityeoneRequiredAnnotation(
				@Option(longNames = { "arg1" }, arity = OptionArity.EXACTLY_ONE, required = true) String arg1) {
			return "Hello " + arg1;
		}
	...
	public static class Registration extends BaseE2ECommands {
		...
		public CommandRegistration testArityBooleanDefaultTrueRegistration() {
			return getBuilder().command(REG, "arity-boolean-default-true")
				.group(GROUP)
				.withOption()
				.longNames("overwrite")
				.type(Boolean.class)
		...
		public CommandRegistration testArityStringArrayRegistration() {
			return getBuilder().command(REG, "arity-string-array")
				.group(GROUP)
				.withOption()
				.longNames("arg1")
				.required()
		...
		public CommandRegistration testArityFloatArrayRegistration() {
			return getBuilder().command(REG, "arity-float-array")
				.group(GROUP)
				.withOption()
				.longNames("arg1")
				.type(float[].class)
		...
		public CommandRegistration testStringArityeoneRequiredRegistration() {
			return getBuilder().command(REG, "string-arityeone-required")
				.group(GROUP)
				.withOption()
				.longNames("arg1")
				.type(String.class)
		...
		public CommandRegistration testArityErrorsRegistration() {
			return getBuilder().command(REG, "arity-errors")
				.group(GROUP)
				.withOption()
				.longNames("arg1")
				.type(String[].class)
