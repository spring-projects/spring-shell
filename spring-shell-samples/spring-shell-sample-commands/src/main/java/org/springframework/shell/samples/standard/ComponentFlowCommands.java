...
public class ComponentFlowCommands extends AbstractShellComponent {
	...
	public String showcase2(@ShellOption(help = "Field1 value", defaultValue = ShellOption.NULL) String field1,
	...
	public void autoselect(@ShellOption(defaultValue = "Field3") String defaultValue) {
