...
The `CommandRegistry` interface defines how command registrations exist in
...
----
include::{snippets}/CommandRegistrySnippets.java[tag=snippet1]
----
...
[source, java, indent=0]
----
include::{snippets}/CommandRegistrySnippets.java[tag=snippet2]
----
...
== Command Catalog Customizer
You can use the `CommandRegistryCustomizer` interface to customize a `CommandRegistry`.
...
[source, java, indent=0]
----
include::{snippets}/CommandRegistrySnippets.java[tag=snippet3]
----

You can create a `CommandRegistryCustomizer` as a bean, and Spring Shell handles the rest.
