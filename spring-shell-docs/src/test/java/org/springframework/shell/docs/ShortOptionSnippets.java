...
public class ShortOptionSnippets {
	...
	static class LegacyAnnotation {
		...
		String stringWithShortOption(@ShellOption(value = { "--arg", "-a" }) String arg) {
		...
		@ShellMethod(key = "example")
		public String multipleBooleans(@ShellOption(value = "-a") boolean a, @ShellOption(value = "-b") boolean b,
